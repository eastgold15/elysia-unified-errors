        ...
        switch (type) {
          ...
          default:
            throw new ValidationError("无效的错误类型", {
              field: "type",
              value: type,
              allowedValues: ["auth", "permission", "validation", "system", "custom", "unknown"],
            });
        }
      })
...
console.log('curl -X POST http://localhost:3000/auth/login -H "Content-Type: application/json" -d \'{ "email": "admin@example.com", "password": "admin123" }\'');
